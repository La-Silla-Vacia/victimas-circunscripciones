    ...
    return (
      <div className={s.container}>
        ...
        <div className="cont_circulos">
          ...
          <div onClick={this.handonclic.bind(this, "En Cundinamarca, uno de los afectados es Javier Ríos", "<p>En Cundinamarca, hay dos tipos de fotomultas: las que depenpen de la Gobernación y las que dependen de la jurisdicción de cada municipio. Por eso, los que más se ven afectados son las dos empresas que reciben la mayor parte del recaudo que se hace a nivel departamental: Data Tools, de Javier Ríos, y la Unión Temporal de Servicios Integrados y Especializados de Tránsito y Transporte de Cundinamarca (Siett). Aunque Data Tools no tiene máquinas de fotomultas, maneja, desde el 2002, toda la infraestructura tecnológica del sistema de tránsito del departamento y por esto recibe el 25 por ciento del recaudo de fotomultas. Este contrato se volvío a hacer en el 2015 e irá por 3 años y 3 meses Siett, por otro lado, se encarga de administrar la parte operativa de las fotomultas: instalar las cámaras, recolectar las pruebas, generar los comparendos y notificar a los infractores. Por esto recibe el 39 por ciento del recaudo. Además de las fotomultas, Siett también tiene concesionado la operación de las grúas, de los patios y la administración de centros donde hacen la revisión técnico mecánica y de gases. Este contrato, en el que la gobernación le concesiona todos estos servicios a Siett ,se firmó en el 2006 y va hasta el 2018.</p>" +
